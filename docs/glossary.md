...
| **Focus** | The max-3 active tasks in `todo/focus.md`. Always loaded into agent context. |
...
| **RACI** | Responsible / Accountable / Consulted / Informed. Required on team and org-unit decisions and TODOs. |
