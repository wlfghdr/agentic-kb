...
**Status**: stable (`v2.0.0`). Setup proposes this skill when role, goals, sources, or desired outputs imply product-management roadmap work. Activate it by confirming the owning layer and declaring `roadmap:` there in `.kb-config/layers.yaml`.
