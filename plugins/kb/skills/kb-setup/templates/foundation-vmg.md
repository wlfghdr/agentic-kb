...
The strategic steering model for this KB. Agents check alignment on every capture (evaluation gate rule 1b).
...
Active, measurable targets. Lifecycle: `active → achieved | deferred | dropped`.

| ID | Description | Horizon | Status |
|----|------------|---------|--------|
{{VMG_GOALS}}
