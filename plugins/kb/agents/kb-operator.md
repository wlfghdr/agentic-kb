...
|------|-------------|--------|
| 2026-09-16 | Version aligned to 6.4.0; the composed kb-management/setup contracts now distinguish canonical tracker CRUD from reserved connection-digest write-back | Issue #152 |
