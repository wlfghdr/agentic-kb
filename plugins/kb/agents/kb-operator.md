...
- `index.html` — public GitHub Pages landing page surfacing generated HTML artifacts plus first-class KB objects (`findings`, `topics`, `ideas`, `decisions`). Generated by `scripts/generate-index.py`.
...
|------|-------------|--------|
| 2026-04-22 | Root `index.html` output contract now includes first-class KB objects (`findings`, `topics`, `ideas`, `decisions`) alongside HTML artifacts, and the declared agent version is bumped to 3.4.4 for the shipped landing-page fix | Fixes #21 |
