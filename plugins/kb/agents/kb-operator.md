...
- `dashboard.html` — owner-facing command center: focus, backlog, pending inputs, active ideas, open decisions, recent findings/digests/reports, workstreams, plus opt-in GitHub/Jira panels. Generated by `scripts/generate-dashboard.py`.
