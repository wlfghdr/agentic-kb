...
- Added the software-engineering operating-model coverage: a new role/artifact analysis doc, optional `delivery` / `operations` feature families in the structural reference, and standard templates for briefs, specs, release records, and incident records.
